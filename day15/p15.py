...
def point_covered_by(point: Point, sensors: list[Sensor]) -> Iterator[Sensor]:
    """return all sensors whose beacons are further away than `point`"""
...
def points_covered_by_beacons(sensors: list[Sensor], y_val: int) -> int:
    """return the number of points covered by beacons (excluding beacons themselves)"""
